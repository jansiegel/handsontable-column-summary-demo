 ...
 *
 * Date: Thu Jun 25 2015 13:11:56 GMT+0200 (CEST)
 */
/*jslint white: true, browser: true, plusplus: true, indent: 4, maxerr: 50 */

window.Handsontable = {
  version: '0.15.0-beta6',
  buildDate: 'Thu Jun 25 2015 13:11:56 GMT+0200 (CEST)'
};
...
Autofill.prototype.apply = function() {
  ...
  if (start && start.row > -1 && start.col > -1) {
    ...
    Handsontable.hooks.run(this.instance, 'afterAutofill', start, end, _data);
  } else {
...
($traceurRuntime.createClass)(ColumnSummary, {
  ...
  refreshChangedEndpoints: function(changes) {
    ...
    for (var i = 0,
        refreshListCount = needToRefresh.length; i < refreshListCount; i++) {
      console.log('refreshing ', this.endpoints[needToRefresh[i]]);
...
//# 
},{"./../../plugins.js":47,"./../_base.js":48}],53:[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
